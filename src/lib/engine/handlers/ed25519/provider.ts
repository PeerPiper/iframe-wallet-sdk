// modified from https://github.com/ceramicnetwork/key-did-provider-ed25519/blob/main/src/index.ts
 ...
 *  https://github.com/StableLib/stablelib/blob/master/packages/ed25519/ed25519.ts#L885
 */
...
export class Ed25519Provider implements DIDProvider {
    ...
    constructor({ publicKey, secretKey }: KeyPair) {
